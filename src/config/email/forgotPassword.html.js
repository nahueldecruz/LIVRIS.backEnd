const getForgotPassword = (name, route) => {
                                ...
                                <tr>
                                    <td style="padding: 30px;">
                                        ...
                                        <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
                                            ...
                                            <tr>
                                                <td>
                                                    <h2 class="title">Recuperá tu contraseña</h2>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td style="padding-top: 10px;">
                                                    <p class="text">Si fuiste vos, podés continuar desde el siguiente botón.</p>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td style="padding-top: 10px;">
                                                    <p class="text">Si no solicitaste este cambio, ignorá este mensaje.</p>
                                                </td>
                                            </tr>
                                            <tr>
